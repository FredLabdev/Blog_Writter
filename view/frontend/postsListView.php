...
<div class="container-fluid">
    ...
    <div class="posts-view">
        ...
        <div class="posts-extracts col-12 white">
            <?php    
                for ($i=0; $i<5; $i++) {
                    if ($postsBy5[$i] != "") {
            ?>
    ...
    <div id="comments-signaled" class="container-fluid posts-view white">
        ...
        <div class="comments-content col-10 offset-1">
            ...
            <span class="row col-12">
                <strong class="col-3 white">
                    <?= $signalComment['author']; ?>
                </strong>
                <span class="col-3 green">
                    le
                    <?= $signalComment['comment_date_fr']; ?>
                </span>
                <span class="col-6 orange text-right"><i class="fas fa-exclamation-circle"></i> signalé le
    ...
    <div class="post-view white">
        ...
        <form method="post" action="index.php?action=addPost">
            ...
            <input type="text" name="titre" class="col-7 news-title" /><br>
            <label>L'insérer après un billet particulier : </label>
            <select name="postBefore" class="col-7 news-title">
                <option value=""></option>
                <?php
