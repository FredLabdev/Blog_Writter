...
<body>
    ...
    <?php    // Récupération des indices de billets max et min de chaque page 
        ...
        echo '<a href="frontend_accueil.php?billet=' . $data['id'] .'">' . 'Cliquer pour accéder aux commentaires de ce billet' . '</a>' . '<br>';
        ...
        $req1->closeCursor(); // Termine le traitement de la requête 1
            ...
            // Une fois le cookie créé on peut faire ensuite un second lien vers page des commentaires
            
        echo '<a href="frontend_comment_billet.php">' . 'Détails ou ajout d\'un nouveau commentaire' . '</a>' . '<br>';
        }
        echo '<p>.......................................................................................</p>';  
        }
