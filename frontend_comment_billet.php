...
<?php     
        ...
        $req->execute(array($_GET['billet'])); // grâce à son id envoyée en paramètre via le lien URL 
        $data = $req->fetch();
        if ($_GET['billet'] AND !$data) {
...
<form method="post" action="frontend_comment_billet.php?billet=<?php echo $_GET['billet']; ?>">
    <p>
